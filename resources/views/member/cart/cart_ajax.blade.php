                                ...
                                @foreach ($cart_ajax as $key => $cart)
                                    <tr>
                                        <td class="shoping__cart__item">
                                            <img style="width: 150px;" src="{{ asset($cart['product_image']) }}"
                                                alt="">
                                            <h5>
                                                <a href="{{route('product.detail', $cart['product_id'])}}">{{ $cart['product_name'] }}</a>
                                            </h5>
                                        </td>
                                        ...
                                        <td class="shoping__cart__quantity">
                                            <div class="quantity">
                                                <div class="pro-qty">
                                                    <input class="cart_quantity_{{ $cart['session_id'] }}" type="number"
                                                        min="1" max="10" value="{{ $cart['product_qty'] }}"
                                                        style="width: 55px;">
                                                    <input type="hidden" class="cart_session_id_{{ $cart['session_id'] }}"
