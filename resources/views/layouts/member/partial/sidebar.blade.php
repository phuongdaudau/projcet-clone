<div id="sidebar">
    {{-- <h3> <a href="{{ route('cart.list') }}"> CART</a></h3> --}}
    <h3> <a href="{{ route('show_cart_ajax') }}"> CART</a></h3>
    <div id="cart">
        ...
        @if ($cart_ajax == true)
            @foreach ($cart_ajax as $key => $cart)
                <div class='cart-item'>
                    ...
                    <strong>{{ $cart['product_price'] }}</strong>
                    <div class='cart-item-border'></div>
                    <input style=""
                            type="button"
                            data-session_id_cart="{{ $cart['session_id'] }}"
                            class="delete-item delete-to-cart" name="delete-to-cart">
